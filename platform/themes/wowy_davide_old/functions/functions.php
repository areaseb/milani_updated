...
add_shortcode('bullets', 'Products bullets', 'Display bullets on product sidebar', function() {
    $prod_id = request()->session()->get('product');
    ...
    return Theme::partial('shortcodes.bullets', compact('attributes'));
});
