    ...
    <div class="product-cart-wrap mb-30">
        <div class="product-img-action-wrap">
            <div class="product-img product-img-zoom">
                <a href="{{ $product->is_variation ? ($product->parentProduct[0]->url . '?s=' . $product->sku) : $product->url }}">
        ...
        <div class="product-content-wrap">
            ...
            @endif
            <h2><a href="{{ $product->is_variation ? ($product->parentProduct[0]->url . '?s=' . $product->sku) : $product->url }}">{{ \Illuminate\Support\Str::limit($product->name, 102, '...') }}</a></h2>
