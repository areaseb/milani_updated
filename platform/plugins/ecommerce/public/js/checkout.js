  ...
  _createClass(MainCheckout, [{
    ...
    value: function init() {
      ...
      var reloadAddressForm = function reloadAddressForm(url) {
        ...
        var billingAddressSelectedCountry = $(customerBillingAddressForm + ' #address_country option:selected').val();
        var billingAddressSelectedState = $(customerBillingAddressForm + ' #address_state option:selected').val();
        var billingAddressSelectedCity = $(customerBillingAddressForm + ' #address_city option:selected').val();
      ...
      var loadShippingFeeAtTheFirstTime = function loadShippingFeeAtTheFirstTime() {
        ...
        if (shippingMethod.length) {
          ...
          $('.mobile-total').text('...');
          reloadAddressForm(window.location.href + '?shipping_method=' + shippingMethod.val() + '&shipping_option=' + shippingMethod.data('option') + ' ' + shippingForm + ' > *');
        }
      };
      ...
      $(document).on('change', 'input[name=shipping_method]', function (event) {
        ...
        disablePaymentMethodsForm();
        $('.mobile-total').text('...');
        reloadAddressForm(window.location.href + '?shipping_method=' + $this.val() + '&shipping_option=' + $this.data('option') + ' ' + shippingForm + ' > *');
      });
